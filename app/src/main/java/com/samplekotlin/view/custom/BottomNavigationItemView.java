...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView (Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(R.layout.view_custom_bottom_navigation_item, this, true);
    ...
    public void setNotificationCount (int count, boolean isVisible) {
        if (isVisible) {
    ...
    public void setTitle (CharSequence title) {
        ...
        mSmallLabel.setTextSize(11);
        mLargeLabel.setTextSize(11);
